            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <table style="margin:20px auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="w3review" name="deskripsi_buku" rows="4" cols="50">{{ $buku->deskripsi_buku }}</textarea>
                            <br>
                    ...
                    <tr>
                        <td>Stok Buku</td>
                        <td>
                            <input type="number" name="stok_buku" value="{{ $buku->stok_buku }}">
                            <br>
